                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding: 0 2.5em;">
                                    <div class="text">
                                        <h3>Terimakasih telah berbelanja.</h3>
                                    </div>
                                    <div class="isi">
                            ...
                            <tr>
                                <td>
                                    <div class="text-author">
                                        <h3 class="name">Ringkasan Order:</h3>
                                        <table class="or-id">
                                            <tr>
                                                <td>Order Id</td>
                                                <td>:</td>
                                            ...
                                            <tr>
                                                <td>Alamat</td>
                                                <td>:</td>
                                                <td>{{$order->alamat_lengkap}}, {{$order->kecamatan}}, {{$order->kabupaten}}, {{$order->provinsi}} - {{$order->kode_pos}}</td>
                                            </tr>
                                            <tr>
                                                <td>No. HP.</td>
                                                <td>:</td>
                                            ...
                                            <tr>
                                                <td>{{ $pro->nama_barang }} x {{ $pro->pivot->jumlah }}</td>
                                                <td>:</td>
                                                @if (app\Product::where('id',$pro->id)->get()->first()->harga_diskon!=0)
                                                    <td>@currency(app\Product::where('id',$pro->id)->get()->first()->harga_diskon*$pro->pivot->jumlah)</td>
                                                @else
                                                    <td>@currency(app\Product::where('id',$pro->id)->get()->first()->harga*$pro->pivot->jumlah)</td>
                                                @endif
