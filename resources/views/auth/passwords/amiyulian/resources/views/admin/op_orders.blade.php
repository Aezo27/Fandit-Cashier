  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">On Process Orders</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Daftar Data Order Yang Sedang Diproses</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-striped table-bordered table-hover projects" style="min-width:1800px">
                ...
                <tr>
                  ...
                  <td style="text-transform: capitalize; text-align:center">
                    @if ($orde->status == "finish")
                        <span class="badge bg-success">{{$orde->status}}</span>
                    @elseif ($orde->status == "diproses")
                        <span class="badge bg-warning">{{$orde->status}}</span>
                    @else
                        <span class="badge bg-danger">{{$orde->status}}</span>
                    @endif
                  </td>
