          ...
          return $('#myTable').DataTable({
            ...
            columnDefs: [{
                ...
                render: function render(data, type, row, meta) {
                  return "<div class=\"custom-control custom-control-nolabel custom-checkbox\">\n            <input type=\"checkbox\" class=\"custom-control-input\" name=\"selectedRow[]\" id=\"p".concat(row.id, "\" value=\"")
                    .concat(
              ...
              },
              {
                targets: 1,
                render: function render(data, type, row, meta) {
                  return "<a href=\"{{ route('gudang.show') }}/".concat(row.id, "\" class=\"tile tile-img mr-1\">\n            <img class=\"img-fluid\" src=\"{{ asset('storage') }}/").concat((row.gambar != null ? row.gambar :
                    'no-image.png'), "\" alt=\"Card image cap\">\n          </a>\n          <a href=\"{{ route('gudang.show') }}/").concat(row.id, "\">").concat(row.nama_barang, "</a>");
                }
              }, {
                targets: 6,
                render: function render(data, type, row, meta) {
                  if (row.deleted_at != null) {
                    return "<a class=\"btn btn-sm btn-icon btn-secondary edit\" href=\"{{ route('gudang.show') }}" + "/" + row.id + "\" data-id=\"".concat(row.id,
                      "\"><i class=\"fa fa-pencil-alt\"></i></a>\n          <a class=\"btn btn-sm btn-icon btn-secondary remove\" href=\"javascript:void()\" data-id=\"").concat(row.id,
                      "\"><i class=\"far fa-trash-alt\"></i></a>\n          <a class=\"btn btn-sm btn-icon btn-secondary restore\" href=\"javascript:void()\" data-id=\"").concat(row.id,
